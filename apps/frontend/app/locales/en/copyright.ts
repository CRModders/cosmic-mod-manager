...
export function Rules(props: CopyrightProps) {
    return `
# ${props.title}
...
If you believe that content hosted on CRMM infringes your copyright, you may submit a takedown request by emailing us at:
...
If you are a user who has received a copyright complaint and believe the material was removed in error, you may respond by submitting a counter notice to:
...
```
CRMM Admin Team
Email: [${props.adminEmail}](mailto:${props.adminEmail})
```
...
We may update this Copyright Policy from time to time. Any changes will be posted on this page and will take effect immediately upon posting.
`;
}
