export const NewPasswordConfirmationEmailTemplate = ({
    ...
    const EmailHTML = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme" content="#252729"><title>Change password</title></head><body style="margin: 0; padding: 0; width: 100%; display: flex; align-items: center; justify-content: center; background-color: #FFFFFF; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto' , 'Oxygen' , 'Ubuntu' , 'Cantarell' , 'Fira Sans', 'Droid Sans' , 'Helvetica Neue' , sans-serif;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%!important"><tbody><tr><td align="center"><table style="border: 1px solid #ACABAD; border-radius: 8px; margin: 48px 0; background-color: #fafafa;"><tbody><tr><td style="padding: 48px; width: 100%; max-width: 375px;"><table width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td align="center"> <img src="https://i.postimg.cc/wxDvLDB4/image.png" style="width: 80px; height: 80px;" /> </td></tr><tr><td align="center"><h1 style="color: #101214; font-weight: 400; font-size: 1.6rem; margin-top: 4px; margin-bottom: 12px;">Verify your new password</h1></td></tr></tbody></table><table width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding-top: 16px; margin-bottom: 0;"><p style="color: #252729; margin-top: 8px; margin-bottom: 0; font-size: 14px;">Hi ${name || "there"
...
export const ChangePasswordVerificationEmailTemplate = ({
    ...
    const EmailHTML = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme" content="#252729"><title>Change password</title></head><body style="margin: 0; padding: 0; width: 100%; display: flex; align-items: center; justify-content: center; background-color: #FFFFFF; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto' , 'Oxygen' , 'Ubuntu' , 'Cantarell' , 'Fira Sans', 'Droid Sans' , 'Helvetica Neue' , sans-serif;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%!important"><tbody><tr><td align="center"><table style="border: 1px solid #ACABAD; border-radius: 8px; margin: 48px 0; background-color: #fafafa;"><tbody><tr><td style="padding: 48px; width: 100%; max-width: 375px;"><table width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td align="center"> <img src="https://i.postimg.cc/wxDvLDB4/image.png" style="width: 80px; height: 80px;" /> </td></tr><tr><td align="center"><h1 style="color: #101214; font-weight: 400; font-size: 1.6rem; margin-top: 4px; margin-bottom: 12px;">Change your password </h1></td></tr></tbody></table><table width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding-top: 16px; margin-bottom: 0;"><p style="color: #252729; margin-top: 8px; margin-bottom: 0; font-size: 14px;">Hi ${name || "there"
...
export const AccountDeletionVerificationEmailTemplate = ({
    ...
    const EmailHTML = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme" content="#252729"><title>Delete your account</title></head><body style="margin: 0; padding: 0; width: 100%; display: flex; align-items: center; justify-content: center; background-color: #FFFFFF; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto' , 'Oxygen' , 'Ubuntu' , 'Cantarell' , 'Fira Sans', 'Droid Sans' , 'Helvetica Neue' , sans-serif;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%!important"><tbody><tr><td align="center"><table style="border: 1px solid #ACABAD; border-radius: 8px; margin: 48px 0; background-color: #fafafa;"><tbody><tr><td style="padding: 48px; width: 100%; max-width: 375px;"><table width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td align="center"> <img src="https://i.postimg.cc/wxDvLDB4/image.png" style="width: 80px; height: 80px;" /> </td></tr><tr><td align="center"><h1 style="color: #101214; font-weight: 400; font-size: 1.6rem; margin-top: 4px; margin-bottom: 12px;">Confirm to delete your account</h1></td></tr></tbody></table><table width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding-top: 16px; margin-bottom: 0;"><p style="color: #252729; margin-top: 8px; margin-bottom: 0; font-size: 14px;">Hi ${name || "there"
