...
export const RemoveMemberDialog = ({ member, refreshData, children }: RemoveMemberDialogProps) => {
...
export const TransferOwnershipDialog = ({ member, teamId, refreshData, children }: TransferOwnershipDialogProps) => {
    const [isLoading, setIsLoading] = useState(false);
    ...
    const transferOwnership = async () => {
        ...
        setIsLoading(true);
        try {
            const res = await useFetch(`/api/team/${teamId}/owner`, {
                method: "PATCH",
