...
>(({ className, ...props }, ref) => (
    <div className="flex items-center border-b border-shallow-background px-3" cmdk-input-wrapper="">
        <SearchIcon className="mr-2 w-btn-icon h-btn-icon shrink-0 text-extra-muted-foreground" />
...
>(({ className, ...props }, ref) => (
    <CommandPrimitive.List ref={ref} className={cn("max-h-[18rem] overflow-y-auto", className)} {...props} />
));
...
>((props, ref) => <CommandPrimitive.Empty ref={ref} className="py-5 text-center text-sm text-muted-foreground" {...props} />);
...
>(({ className, ...props }, ref) => (
    <CommandPrimitive.Separator ref={ref} className={cn("-mx-1 h-px bg-shallow-background", className)} {...props} />
));
