...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
            ...
            className={cn(
                "z-50 min-w-[8rem] overflow-hidden rounded border border-shallow-background bg-card-background p-1 text-foreground shadow-md",
...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.Separator ref={ref} className={cn("-mx-1 my-1 h-px bg-shallow-background", className)} {...props} />
));
