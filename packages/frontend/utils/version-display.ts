import GAME_VERSIONS, { gameVersionsList as AllGameVersions, type GameVersion } from "@shared/config/game-versions";
import { sortVersionsWithReference } from "@shared/lib/utils/project";
import { GameVersionReleaseType } from "@shared/types";
