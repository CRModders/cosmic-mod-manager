...
import type { SecureServerOptions, ServerOptions as ServerOptions$3, createSecureServer, createServer as createServer$2 } from "node:http2";
...
export type CreateNodeServerOptions = createHttpOptions | createHttpsOptions | createHttp2Options | createSecureHttp2Options;
