...
export type HonoServerOptions<E extends Env = BlankEnv> = HonoCloudflareOptions<E> & Omit<WithoutWebsocket<E>, "useWebSocket">;
...
function serveCloudflareAssets() {
    return createMiddleware(async (c, next) => {
        ...
        try {
            let response = (await binding.fetch(c.req.url, c.req.raw.clone() as unknown as RequestInit)) as unknown as globalThis.Response;
