...
export type HonoServerOptions<E extends Env = BlankEnv> = HonoServerOptionsWithWebSocket<E> | HonoServerOptionsWithoutWebSocket<E>;
 ...
 */
export async function createHonoServer<E extends Env = BlankEnv>(options?: HonoServerOptionsWithoutWebSocket<E>): Promise<CustomBunServer>;
export async function createHonoServer<E extends Env = BlankEnv>(options?: HonoServerOptionsWithWebSocket<E>): Promise<CustomBunServer>;
export async function createHonoServer<E extends Env = BlankEnv>(options?: HonoServerOptions<E>) {
    ...
    function HandleDocRequests(ctx: Context) {
        return requestHandler(ctx);
    }

    app.all("*", HandleDocRequests);
