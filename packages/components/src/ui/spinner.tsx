...
export const WanderingCubesSpinner = ({
	...
	return (
		<span
			className={cn(
				"wandering_cubes_animation flex items-center justify-center text-muted-foreground",
				className,
			)}
			role="presentation"
			aria-label="Loading"
...
export const FullPageSpinner = ({
	size,
	className,
}: { size?: LoaderSizes; className?: string }) => {
	return (
		<div
			className={cn(
				"w-full full_page flex items-center justify-center",
				className,
			)}
		>
...
export const SuspenseFallback = ({
	className,
	spinnerClassName,
}: { className?: string; spinnerClassName?: string }) => {
	return (
		<div
			className={cn("w-full flex items-center justify-center py-12", className)}
		>
