...
export const SunIcon = ({ size, width, height, className }) => {
...
export const MoonIcon = ({ size, width, height, className }) => {
	const { IconWidth, IconHeight } = ParseSize({ size, width, height });
...
export const HeroSectionBrandLogo = ({ size, width, height, className }) => {
	const { IconWidth, IconHeight } = ParseSize({ size, width, height });
	...
	return (
		...
		<svg
			...
			width={IconWidth}
			height={IconHeight}
			className={`icon hero_section_brand_icon ${className}`}
		>
			<path
