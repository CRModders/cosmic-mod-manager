	...
	content: {
		...
		api_responses: {
			user: {
				...
				cant_unlink_the_last_auth_provider: "Вы не можете отвязать единственного провайдера авторизации",
				...
				password_login_not_enabled_desc:
					"Пароль можно изменять только на тех аккаунтах, на которых он был добавлен. Если вы этого не делали, вы можете попробовать использовать провайдера авторизации для входа.",
				successfully_deleted_account: "Ваш аккаунт был успещно удалён",
				cancelled_account_deletion: "Удаление аккаунта успещно отменено",
			},
		},
		auth: {
			dashboard: "Дэшборд",
			...
			action_verification_page: {
				...
				cancelled_successfully: "Успешно отменено",
				password_changed: "Пароль успещно изменён",
		...
		home_page: {
			hero: {
				description: {
					line_1: "Лучшее местов для модов [Cosmic Reach].",
		...
		settings_page: {
			...
			sessions_section: {
				...
				session_page_warning_message:
					"Эта страница содержит такие персональные данные, как ваш IP-Адрес и местоположение. Пожалуйста, не отправляйте скришоты, записи экрана и любую другую информацию с этой страницы посторонним людям.",
				page_desc: {
					line_1:
